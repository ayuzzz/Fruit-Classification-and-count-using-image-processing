...
train_path  = "E:/BE_PROJECT/Working_Module/T"
...
data =train_features
path = "E:/BE_PROJECT/Working_Module/features_small.csv"
csv_writer(data, path)

labels =train_labels
path = "E:/BE_PROJECT/Working_Module/labels_small.csv"
      ...
      if(self.e1.get()=="fruit" and self.e2.get()=="skn"):
                ...
                def result() :
                    if(pressed == 1):    
                            ...
                            ret, labels = cv2.connectedComponents(im_erosion)
                            output = cv2.connectedComponentsWithStats(im_erosion,8)
                            # Get the results
